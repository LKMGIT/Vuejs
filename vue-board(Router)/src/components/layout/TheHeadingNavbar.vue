        ...
        <ul class="navbar-nav me-auto ms-5 my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><router-link :to="{ name: 'notice' }" class="nav-link">공지사항</router-link>
              
              </li>
              <li><router-link :to="{ name: 'faq' }" class="nav-link">FAQ</router-link></li>
              <li>
                <hr class="dropdown-divider" />
              </li>
              <li><li><router-link :to="{ name: 'store' }" class="nav-link">매장이용안내</router-link></li></li>
            </ul>
          </li>
          <li class="nav-item">
